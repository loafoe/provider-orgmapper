# ====================================================================================
# Setup Project
PROJECT_NAME := provider-orgmapper
...
XPKGS = provider-orgmapper
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-orgmapper: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider OrgMapper CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider OrgMapper controllers
...
# This target prepares repo for your provider by replacing all "orgmapper"
